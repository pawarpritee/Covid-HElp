...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if((data.equals("Customer"))&& (data!=null))
        {
            ...
            skip_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent=new Intent(LoginActivity.this,geofind.class);
    ...
    private void sendUserToHome() {
        Intent homeIntent = new Intent(LoginActivity.this, Home2Actiivity.class);
        homeIntent.putExtra("data",data);
        homeIntent.putExtra("phoneno",phoneno);
